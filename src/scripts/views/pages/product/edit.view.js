      ...
      <div id="product-edit" x-data="editProduct">
        <div class="border rounded-lg-shadow-lg p-10 top-48">
          ...
          <div class="category mb-2">
            <form action="">
              <label>
                <h2 class="text-emerald-600">Category</h2>
              </label>
              <label for="food">
          ...
          <div class="custom-file-container" data-upload-id="myFirstImage">
            <div class="label-container">
              <label>Upload</label>
              <a class="clear-button" href="javascript:void(0)" title="Clear Image"> × </a>
            </div>
            <label class="input-container">
              <input accept="*" aria-label="Choose File" class="input-hidden" id="file-upload-with-preview-myFirstImage" type="file">
              <span class="input-visible">Choose file... <span class="browse-button">Browse</span>
              </span>
            </label>
          </div>
          <div>
